...
在[关于动态规划，你该了解这些！ (opens new window)](https://programmercarl.com/动态规划理论基础.html)中我们讲解了动态规划的基础知识。
...
## [#](https://programmercarl.com/周总结/20210107动规周末总结.html#周二)周二

这道题目[动态规划：斐波那契数 (opens new window)](https://programmercarl.com/0509.斐波那契数.html)是当之无愧的动规入门题。

简单题，我们就是用来了解方法论的，用动规五部曲走一遍，题目其实已经把递推公式，和dp数组如何初始化都给我们了。

## [#](https://programmercarl.com/周总结/20210107动规周末总结.html#周三)周三

[动态规划：爬楼梯 (opens new window)](https://programmercarl.com/0070.爬楼梯.html)这道题目其实就是斐波那契数列。
...
我在[通过一道面试题目，讲一讲递归算法的时间复杂度！ (opens new window)](https://programmercarl.com/前序/通过一道面试题目，讲一讲递归算法的时间复杂度！.html)中，以我自己面试别人的真实经历，通过求x的n次方 这么简单的题目，就可以考察候选人对算法性能以及递归的理解深度，录友们可以看看，绝对有收获！

## [#](https://programmercarl.com/周总结/20210107动规周末总结.html#周四)周四

这道题目[动态规划：使用最小花费爬楼梯 (opens new window)](https://programmercarl.com/0746.使用最小花费爬楼梯.html)就是在爬台阶的基础上加了一个花费，
...
## [#](https://programmercarl.com/周总结/20210107动规周末总结.html#总结)